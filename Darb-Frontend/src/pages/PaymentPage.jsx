...
const PaymentPage = () => {
  ...
  const loadCampaignAndPaymentData = async () => {
    try {
      ...
      if (pendingPayment.isCustomAmount) {
        ...
        if (
          pendingPayment.milestoneIds &&
          campaignData.financials?.milestones
        ) {
          const milestones = pendingPayment.milestoneIds
            .map((id) =>
              campaignData.financials.milestones.find((m) => m.id == id)
            )
  ...
  const processPayment = async () => {
    try {
      ...
      navigate(
        `/payment/verify/${paymentId}?reference=${encodeURIComponent(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              The campaign you're trying to fund doesn't exist.
            </p>
            <button
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              You need to select milestones or enter a custom amount to fund
              this campaign.
            </p>
            <button
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  <div className="flex items-start">
                    ...
                    >
                      I agree to the terms and conditions, including authorizing
                      this payment and the collection of my payment information.
                    </label>
                  </div>
