    ...
    <div className="relative min-h-[90vh] flex items-center overflow-hidden bg-gray-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 py-24 w-full">
        <div className="max-w-3xl">
          {/* Badge */}
          <motion.div {...fadeUp(0)} className="inline-flex items-center space-x-2 bg-primary-900 border border-primary-500/25 rounded-full px-4 py-2 mb-8">
            <span className="w-2 h-2 bg-primary-400 rounded-full animate-pulse" />
            <span className="text-primary-100 text-sm font-medium">Africa's leading startup funding platform</span>
          </motion.div>
