...
const steps = [
  {
    ...
    description:
      'Build a compelling campaign page with your pitch, financials, and milestones. Our guided editor makes it simple.',
  ...
  },
  {
    ...
    description:
      'Our platform surfaces your campaign to verified investors who align with your industry and funding stage.',
  ...
  },
  {
    ...
    description:
      'Receive funds as you hit milestones. Track progress, communicate with investors, and scale your startup.',
          ...
          {steps.map(({ icon: Icon, step, title, description, color }, i) => (
            <div key={step} className="relative z-10 flex flex-col items-center text-center group">
              ...
              <div className="relative mb-6">
                <div className={`w-20 h-20 rounded-2xl ${color} flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform`}>
