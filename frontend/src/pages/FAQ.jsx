  ...
  return (
    ...
    >
      <button
        ...
        onClick={onClick}
      >
        <span className="text-xl font-medium text-gray-900 pr-8 group-hover:text-purple-700">
          {question}
        </span>
        <ChevronDown
            ...
            >
              <Bookmark
                className={`h-4 w-4 mr-1 ${
                  bookmarked ? "fill-purple-700 text-purple-800" : ""
                }`}
              />
...
const FAQ = () => {
  ...
  const faqData = [
    // Original FAQs
    {
      ...
      answer:
        "You can make a donation through our secure online platform using your credit card, debit card, or PayPal account. Simply click the donate button and follow the instructions.",
    },
    {
      id: 2,
      category: "payments",
      ...
      answer:
        "Yes, all donations are tax-deductible to the extent allowed by law. You will receive a tax receipt for your records.",
    },
    {
      id: 3,
      category: "general",
      ...
      answer:
        "Yes, you can make a donation in honor or memory of someone special. During the donation process, you'll have the option to specify this information.",
    },
    {
      id: 4,
      category: "payments",
      ...
      answer:
        "Your donation will be used to support our mission and programs. We ensure transparency in how funds are allocated and used.",
    },
    {
      id: 5,
      category: "payments",
    ...
    // New FAQs for Nigerian P2P lending
    {
      ...
      category: "process",
      question:
        "How does the P2P lending process work for startups in Nigeria?",
      answer:
        "Our platform connects Nigerian startups with investors through a transparent P2P lending model. Startups create detailed campaign pages with funding goals and milestone deliverables. Investors can browse campaigns, perform due diligence, and contribute funds to specific milestones. Funds are only released when pre-defined milestones are achieved and verified, ensuring accountability throughout the funding journey.",
    },
    {
      id: 7,
      category: "requirements",
      question:
        "What documentation do I need to register as a startup borrower?",
      answer:
        "Startup borrowers need to provide: Business registration certificate (CAC documents), Bank Verification Number (BVN), valid ID (National ID, International Passport, or Driver's License), business plan, financial projections, bank account details, and supporting documents like pitch deck and product demos. Additional sector-specific documentation may be required for regulated industries.",
    },
    {
      id: 8,
      category: "requirements",
    ...
    },
    {
      ...
      answer:
        "Interest rates typically range from 8% to 25% per annum depending on your risk assessment, business stage, and loan duration. Our platform charges a 3% origination fee on successfully funded campaigns. For partial funding, a 1.5% facilitation fee applies. There are no application fees, but late repayments incur a 1% penalty fee. All rates and fees are transparent and displayed before campaign launch.",
    },
    {
      id: 10,
      category: "process",
      question:
        "How are funds disbursed and what is the milestone verification process?",
      answer:
    ...
    },
    {
      ...
      answer:
        "If you anticipate payment difficulties, contact us at least 7 days before your due date to discuss restructuring options. For late payments, a 1% penalty applies in the first 15 days. After that, we implement a graduated penalty system and work with you on a recovery plan. Persistent defaults may result in collateral claims, reporting to credit bureaus, and legal action. We always prioritize collaborative solutions before enforcement.",
    },
  ];
          ...
          {filteredFAQs.length > 0 ? (
            ...
            <div className="py-16 text-center">
              ...
              <p className="mt-2 text-gray-500">
                No FAQs match your search criteria. Try adjusting your search or
